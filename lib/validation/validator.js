...
var validator = function (req, res, next) {
    ...
    this.required = function (field) {
        if (typeof data[field] === 'undefined' || data[field] === null || data[field].length === 0) {
    ...
    this.min = function (field, param) {
        ...
        // Valid number
        if(valueNumber !== 'NaN' && valueNumber !== 0 && valueNumber < param) {
            return this.setErrorMessage('min', field, valueNumber, param);
        }
        // Valid String
        else if (typeof value === 'string' && value.length !== 0 && value.length < param) {
            return this.setErrorMessage('min', field, value, param);
        }
    };
    ...
    this.max = function (field, param) {
        ...
        // Valid number
        if(valueNumber !== 'NaN' && valueNumber !== 0 && valueNumber > param) {
            return this.setErrorMessage('max', field, valueNumber, param);
        }
        // Valid String
        else if (typeof value === 'string' && value.length !== 0 && value.length > param) {
            return this.setErrorMessage('max', field, value, param);
        }
    };
    ...
    this.boolean = function (field) {
        ...
        if (typeof data[field] !== 'undefined' && data[field] && testBoolean.indexOf(data[field]) == -1) {
